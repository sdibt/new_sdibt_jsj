...
<div class="wrapper row3">
  <div id="container" class="clear">
   ...
   <div id="content" style="width:600px;margin:20px 0 0 100px">
      <h1 class="title" style="font-style:normal">搜索结果&raquo;</h1>
	      <ul class="" style="margin-left:30px;font-size:16px">
	          ...
	          <a href="/sdibt_jsj/index.php/Home/Search/showSearchContent?type_id=<?php echo ($Pagecon['type_id']); ?>&news_id=<?php echo ($Pagecon['news_id']); ?>"><?php echo ($Pagecon['title']); ?>
