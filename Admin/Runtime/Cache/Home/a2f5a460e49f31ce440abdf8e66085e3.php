...
<body>
    ...
    <div class="content clearfix" style="height:660px">
        <div class="main">
            <!--右侧内容-->
            <div class="cont">
                <div class="title">幻灯片设置&raquo;</div>
                <div class="details">
                    <div class="details_operation clearfix">
                        <div class="bui_select">
                            <a href="<?php echo U('Home/HomePage/showAddPic');?>"><input type="button" value="添     加" class="add"></a>
                        </div>
                    </div>
                    <!--表格-->
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center"><?php echo ($res['show1']); ?></td>
                                <td align="center">
                                <a href="/sdibt_jsj/admin.php/Home/HomePage/changePic/id/<?php echo ($res['id']); ?>">
                                <input type="button" value="<?php echo ($res['show2']); ?>" class="btn"></a>
                                <a href="/sdibt_jsj/admin.php/Home/HomePage/delPic/id/<?php echo ($res['id']); ?>">
