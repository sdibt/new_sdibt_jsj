...
<body>
    ...
    <div class="content clearfix" style="height:660px">
        <div class="main">
            <!--右侧内容-->
            <div class="cont">
                <div class="title">首页内容&raquo;</div>
                <div class="details">
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center">
                                <a href="/sdibt_jsj/admin.php/Home/HomePage/updSet/id/<?php echo ($res['news_id']); ?>">
                                <input type="button" value="修改" class="btn"></a>
                                <a href="/sdibt_jsj/admin.php/Home/HomePage/delSet/id/<?php echo ($res['news_id']); ?>">
