                ...
                <div class="details">
                    <div class="details_operation clearfix">
                        <div class="bui_select">
                            <a href="<?php echo U('Home/HomePage/showAddNews');?>"><input type="button" value="添     加" class="add"></a>
                        </div>
                        <div class="fr">
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center">
                                <a href="/sdibt_jsj/admin.php/Home/HomePage/updNews/id/<?php echo ($res['news_id']); ?>">
                                <input type="button" value="修改" class="btn"></a>
                                <a href="/sdibt_jsj/admin.php/Home/HomePage/delNews/id/<?php echo ($res['news_id']); ?>">
